...
import DraggableTask from "./dragable-task";
...
export default function DragableColumn({
  ...
  return (
    <div className="relative m-2 h-full w-xs overflow-hidden rounded-lg bg-black">
      <div className="grid grid-rows-[auto,1fr,auto]">
        <div className="grid grid-cols-[1fr,auto] items-start gap-2 px-4 py-2">
